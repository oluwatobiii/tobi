...
function tobi_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'tobi' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'tobi' ),
...
function tobi_scripts() {
	...
	wp_enqueue_script( 'tobi-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'tobi-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
